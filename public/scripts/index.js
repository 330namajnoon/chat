...
socket.on("data_load",(data) => {
    if(data.data !== "" && data.database) {
        datas[data.database] = JSON.parse(data.data);
...
function RabetKarbari () {
    function NavarAbzar () {
        ...
        this.sartitr = CrateElement({name: "div",id: "sartitr",style: this.styles.sartitr});
        ...
        this.appname = CrateElement({name: "h1",id: "appname",inerhtml: "Sinagram",style: this.styles.spans+";font-size: 20px;margin-left: 4%"});
        this.paszamine_s = CrateElement({name: "div",id: "sartitr",style: this.styles.paszamine_s});
        this.profiller_dosyasi = CrateElement({name: "div",id: "dosyalar",inerhtml: dil.mesajlar,style: this.styles.dosyalar});
        this.chat_dosyasi = CrateElement({name: "div",id: "dosyalar",inerhtml: dil.arkadaslar,style: this.styles.dosyalar+";left: 45%; background-color: "+color.c_1+""});
        ////// apendchilds
    ...
    NavarAbzar.prototype.namayesh_profilha = function() {
        ...
        function Profil(dada) {
            ...
            this.paszamine = CrateElement({name: "div",id: "paszamine",style: this.styles.paszamine});
            this.img = CrateElement({name: "img",src: this.data.img,id: "paszamine",style: this.styles.paszamine});
